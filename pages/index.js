  ...
  return (
    <>
      ...
      <Container>
        ...
        <p>While you're still encouraged to wear a mask and distance yourself from others where possible, the government is ending it's restrictions on travel, masks and other things in some areas.</p>
        <p>Information &amp; resources can be found by searching "COVID-19 rules in my area" online.</p>
        <p>
          <span style={{ fontWeight: 500 }}>Free testing remains in place until April 1st 2022.</span>
          &nbsp;After which you'll no longer be able to request a COVID test for free, and if required to test you must purchase one yourself.
        </p>
